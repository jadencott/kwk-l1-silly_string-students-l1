...
your_favorite_word = "majestic"

puts "My favorite word is majestic"
...
puts "MY FAVORITE WORD IS majestic".upcase
...
bigger_word = "supercalifragilisticexpialidociousmom".length # Use String concatenation to add "wow" and "mom" to big_word
